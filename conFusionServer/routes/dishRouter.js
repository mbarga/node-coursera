...
.put(cors.corsWithOptions, authenticate.verifyOrdinaryUser, authenticate.verifyUser, authenticate.verifyAdmin, (req, res, next) => {
    res.statusCode = 403;
...
.delete(cors.corsWithOptions, authenticate.verifyOrdinaryUser, authenticate.verifyUser, (req, res, next) => {
    Dishes.findById(req.params.dishId)
    .then((dish) => {
        if (dish.comments.id(req.params.commentId).author.equals(req.user.id)) {
            if (dish != null && dish.comments.id(req.params.commentId) != null) {
